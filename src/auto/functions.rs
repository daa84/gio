...
//pub fn dbus_address_get_stream_finish<P: IsA</*Ignored*/AsyncResult>>(res: &P, out_guid: /*Unimplemented*/String) -> Result</*Ignored*/IOStream, Error> {
...
//pub fn resources_get_info(path: &str, lookup_flags: ResourceLookupFlags) -> Result<(/*Unimplemented*/Fundamental: Size, u32), Error> {
//    unsafe { TODO: call ffi::g_resources_get_info() }
//}
